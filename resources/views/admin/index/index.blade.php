...
{{--                    <li><a data-href="{{ route('admin.user.index') }}" data-title="管理员列表" href="javascript:;">管理员列表</a></li>--}}
        ...
        <dl id="menu-admin">
            <dt><a data-href="{{ route('admin.project.index') }}" data-title="工程案例" href="javascript:;" ><i class="Hui-iconfont">&#xe616;</i> 工程案例
                </a>
            </dt>
        ...
        <dl id="menu-admin">
            <dt><a data-href="{{ route('admin.material') }}" data-title="材料展示" href="javascript:;" ><i class="Hui-iconfont">&#xe62d;</i> 材料展示
                </a>
            </dt>
        ...
        <dl id="menu-admin">
            <dt><a data-href="{{ route('admin.news.index') }}" data-title="行业资讯" href="javascript:;" ><i class="Hui-iconfont">&#xe62d;</i> 行业资讯
                </a>
            </dt>
        ...
        <dl id="menu-admin">
            <dt><a data-href="{{ route('admin.knowledge') }}" data-title="防水知识" href="javascript:;" ><i class="Hui-iconfont">&#xe62d;</i> 防水知识
                </a>
            </dt>
